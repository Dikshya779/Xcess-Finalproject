    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 19%;">Student Backpack</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                       <h6>Solid brown backpack with ample storage space
                        Features a large zipper compartment with a laptop pocket, 1 outer zip pocket and a side pocket for carrying a water bottle
                        Padded back and curved shoulder straps that are adjustable make for comfy carrying
                        Top loop makes for easy hanging at home or when you're at work or school</h6>
                    </h5>
