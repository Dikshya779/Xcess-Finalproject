    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 23%;">Notebook</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                       <h6>The perfect pen set for writing, notetaking, or drawing. These fineliner pens create a clean and precise line, every time </h6>
                    </h5>
