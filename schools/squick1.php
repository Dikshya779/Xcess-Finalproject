    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 24%;">Spiral Notebook</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                       <h6>The pages in a notebook are often lined, so that you can write neatly. You might keep one for writing to-do lists or thoughts (like a journal), or your notebooks might all be large binders full of class notes and math problems. </h6>
                    </h5>
