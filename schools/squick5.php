    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 18%;">Pencil-Case</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Perfect for school, home or office
                            Expandable elastic band that attaches to your notebook, binder, etc.
                            Holds all your favorite pens, pencils and everyday supplies
                            Spot clean with mild soap and warm water
                            Dimensions: 4.50" x 2.50" x 9.00" </h6>
                    </h5>
