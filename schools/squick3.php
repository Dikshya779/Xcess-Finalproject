    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 24%;">Ring Binder Black</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                       <h6>Wide front and back binder panels fully cover standard dividers and sheet protectors. </h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/ring3.webp">
                        <div class="card-title">
                            <h4>Ring Binder Black</h4>
                        </div>
                        <div class="card-text">
                            4 inside pockets conveniently hold loose sheets, handouts, business cards and more
