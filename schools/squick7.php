    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Notebook</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                       <h6> The pages are micro-perforated so that you can easily tear them out and the 3-hole punches on the pages allow them to easily be clipped in a binder. This notebook has 70 sheets and is printed with wide ruled lines on the front and back, allowing you to write on both sides.</h6>
                    </h5>
