    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Soft Tip Darts Tri-Pack</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>
                            Simple and durable, put your trust in it to discover how much fun darts can be. 
                        </h6>
                    </h5>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/games3.jpeg">
                        <div class="card-title">
                            <h4>Darts</h4>
                        </div>
                        <div class="card-text">

                            Dart weighs 14 g. Barrel diameter: 7.25 mm. Barrel length: 40 mm.
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card-1">
                        <img class="card-img-top img-fluid"
                            src="../assets/games4.jpeg">
                        <div class="card-title">
                            <h4>Balls</h4>
                        </div>
                        <div class="card-text">
                            The balls easily stick to the target thanks to their hook & loop strips.
