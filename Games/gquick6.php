    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 23%;">Badminton</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row mt-4">
                        ...
                        <a class="btn btn-danger text-light">
                            Red</a>&nbsp;<a class="btn btn-primary text-light">
                                Blue</a>&nbsp;
                    </div>
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>
                            To discover badminton in leisure to play with family or friends
                            This racket gives you an easy, fun and affordable way of getting into badminton.
                        </h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-text">
                            ...
                            POWER:
                            weight (300 g) and round 625 cm² <br>
                            SPIN:
                            Round head and 16x19 string pattern increase the amount of spin.
                            PRECISION:
                            The high-modulus carbon (HMC) fibre graphite improves ball control
                            <div class="product-content">
                                <div class="price">Rs.2400</div>
