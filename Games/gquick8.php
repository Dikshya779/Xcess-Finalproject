    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 27%;">Basketball</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <h3 class="text-warning"><span class="text-warning">
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star" aria-hidden="true"></i>
                                <i class="fa fa-star-o" aria-hidden="true"></i></i></span>
                        </h3>
                        &nbsp; &nbsp;
                    ...
                    <div class="row mt-4 colors">
                        <h4>Colors: &nbsp; &nbsp; </h4>

                        <a class="btn btn-warning text-light">
                            Yellow</a>&nbsp;<a class="btn btn-primary text-light">
                            Blue</a>&nbsp;
                    </div>
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>
                            Size 7 basketball designed and suitable for playing outdoors or indoors, for men and boys
                            ages 13 and up.
                            This size 7 basketball for men and boys is perfect for improving your game. Polyurethane
                            exterior for an excellent ball feel. Available in FIBA-approved version.
                        </h6>
                    </h5>
        ...
        <div class="container">
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-text">
                            ...
                            BOUNCE:
                            Bladder covered by 70% polyester and 30% nylon for excellent bounce.<br>
                            TRACTION:
                            Good grip thanks to a hollow channel design.<br>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card-1">
                        <img class="card-img-top img-fluid" src="../assets/ball1.jpeg">
                        <div class="card-title">
                            <h4> Basket-Backboard Set</h4>
                        </div>
                        <div class="card-text">
                            EASY ASSEMBLY / DISMANTLING:
                            Very easy to attach to a door using its two hooks.<br>
                             BOUNCE:
                            Transparent polycarbonate backboard for a good rebound.<br>
