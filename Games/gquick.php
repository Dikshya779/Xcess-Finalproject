    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Cricket-Ball</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Cricket Leather ball players, regular training. FLX non-toxic 4 piece leather ball is hand
                            stitched for superior quality and perfection. The core is solid with cork construction. This
                            ball adheres to the BCCI leather ball specifications
                        </h6>
                    </h5>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="card-1">
                        ...
                        <div class="card-text">
                            Size: 2.59 inches diameter<br>
                            Good quality <br>
                            2 x 4 Yellow Balls<br /><br />
                            <div class="product-content">
