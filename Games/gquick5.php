    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Electronic-Dartboard</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>
                            Designed for discovering with family or among friends the fun of playing with soft tip
                            darts.
                            Are you looking for a simple to use dartboard for having some good family fun? The Plastip
                            dartboard and its 3 darts are made for you.
                        </h6>
                    </h5>
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-title">
                            <h4 style="padding-right: 20%;">Dartboard</h4>
                        </div>
                        <div class="card-text">
                            EASE OF USE:
                             Easy to install<br>
                        	COMPATIBILITY:
                             Compatible with soft tip darts and blowguns<br>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card-1">
                        ...
                        <div class="card-text">
                            3-piece construction<br> 
                            Shafts and flights are interchangeable<br>
                            <div class="product-content">
