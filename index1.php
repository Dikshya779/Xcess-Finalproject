					...
					<div class="row">
						<div class="col-lg-7 col-md-7">
							<div class="slide-text">
								<h6 style="color:#c4752c">N E W &emsp; C O L L E C T I O N</h6>
		...
		<div class="container-2">
			...
			<div class="row">
				<div class="col-xs-6 col-sm-6 col-lg-3">
					...
					<a href="artandcraft.php"><img class="img-fluid" src="./assets/art.jpeg" alt=""></a>	
						<a href="artandcraft.php"><button class="categoryname">Art and Craft</button></a>
					</div>  
				</div>
				<div class="col-xs-6 col-sm-6 col-lg-3">
					<div class="categorylist category-2">
						<a href="games.php"><img class="img-fluid" src="./assets/games.jpeg" alt=""></a>
						<a href="games.php"><button class="categoryname">Games</button></a>
					</div>
				</div>
				<div class="col-xs-6 col-sm-6 col-lg-3">
					<div class="categorylist category-3">
						<a href="office.php"><img class="img-fluid" src="./assets/office_basics.jpg" alt=""></a>
						<a href="office.php"><button class="categoryname">Office Supplies</button></a>
					</div>
				</div>
				<div class="col-xs-6 col-sm-6 col-lg-3">
					<div class="categorylist category-4">
					<a href="school.php"><img class="img-fluid" src="./assets/school.jpeg" alt=""></a>
						<a href="school.php"><button class="categoryname">School Supplies</button></a>
					</div>
				</div>
			</div>
		</div>
