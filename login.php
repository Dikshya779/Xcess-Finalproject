...
<div class="headerSection">
				...
				<nav class="navbar navbar-expand-lg">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav NavInner">
							...
							<li>
								<a href="cart.php" style="font-size:20px; margin-top:5px;"><i class="fas fa-shopping-cart"></i></a>
							</li>
							<li class="nav-item dropdown">
	...
	<form class="form2" method="post" action="login.php">
		...
		<p>
			Sign-up first to be a member <a href="register.php" button type="submit" class="btn btn-primary">Sign up</a>
		</p>
	</form>
