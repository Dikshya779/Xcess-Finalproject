    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1  style="padding-right: 20%;">Clasp Envelopes</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row mt-4">
                        ...
                        <a class="btn btn-wooden text-light">
                            yellow</a>&nbsp;
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>
                            Quality Park 9 x 12 Clasp Envelopes

                            Reusable double prong metal clasp is durable and designed for repeated use

                            Eyelets are reinforced to last

                            Heavyweight 28 lb. brown Kraft stock to give contents extra protection

                            In addition to the clasp flaps are gummed for a more permanent seal when needed

                            Perfect for organizing and storage

                            Conveniently packed in large 100 count to reduce purchasing</h6>
                    </h5>
