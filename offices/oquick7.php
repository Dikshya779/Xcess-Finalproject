    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1  style="padding-right: 25%;">Sticky Notes</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row mt-4 colors">
                        ...
                        <a class="btn btn-primary text-light">
                            blue</a>&nbsp;<a class="btn btn-info text-light">
                            sky-blue</a>&nbsp;<a class="btn btn-danger text-light">
                            pink</a>&nbsp;
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>3 in x 3 in, Blue and Green pack or Pink and Orange pack
                            Always there when you need to capture great ideas.
                            Accordion-style notes are specially designed to work in Post-it Pop-up Note dispensers.
                            Unique adhesive designed for use on paper or in planners.
                            Use for notes or reminders to yourself or others.</h6>
                    </h5>
