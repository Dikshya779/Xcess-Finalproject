    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Desk Manager</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                       <h6>Three-Tier Desktop Organizer Tray is made from steel, which is built to last and can easily hold paper, folders, and stationery items without a problem. It’s also engineered with a mesh design for visibility and easy access. This free-standing file folder organizer needs no assembly. There is also no need to attach it to the walls or your desk.</h6>
                    </h5>
