    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">File Folders</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Comes in assorted jewel tone colors and is made of 10.5-point paper stock for durability
                            Three assorted-position top tabs allow for ample space for labeling to keep your files
                            organized.
                            Letter-size folder easily holds important files
                            100 folders per pack</h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/stapler.jpeg">
                        <div class="card-title">
                            <h4>Smead Hanging File Folders</h4>
                        </div>
                        <div class="card-text">
                            Durable paper stock folders 
                            Single tab hanging file folder
                            Accommodates letter-size papers and files
                            Contains 10 file folders per box
                            Acid-free for archival quality
                            Made from 10% recycled material with at least 10% post-consumer material
