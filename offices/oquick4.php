    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 25%;">Desk Tape</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="https://i5.walmartimages.com/asr/5155ab37-e1d4-4a2a-ae96-8f752b3cc4db_1.b8e6bf9c55dc2d1aedf7a5d45b2fb435.jpeg?odnWidth=612&odnHeight=612&odnBg=ffffff">
                        <div class="card-title">
                            <h4>Transparent Tape</h4>
                        </div>
                        <div class="card-text">
                            Post-consumer-wastepct: 0pct
                            Color: Clear
                            Length: 1296 In
                            Product Type: Invisible
                            Core Size: 1 In
