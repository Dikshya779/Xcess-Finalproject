    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-left: 1rem;">Crayons</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row mt-4 colors">
                        ...
                        <a class="btn btn-primary text-light">
                            blue</a>&nbsp;<a class="btn btn-danger text-light">
                            red</a>&nbsp;<a class="btn btn-dark text-light">
                            black</a>&nbsp;<a class="btn btn-info text-light">
                            sky blue</a>&nbsp;<a class="btn btn-success text-light">
                            green</a>&nbsp;<a class="btn btn-warning text-light">
                            yellow</a>&nbsp;
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Get creative and express yourself through a rainbow of color with Crayons, 24ct from up &
                            up. This pack of 24 crayons provide vibrant, quality color for all your projects.</h6>
                    </h5>
            ...
            <div class="row mt-5">
                <div class="col-lg-3 col-md-12">
                    <div class="card">
                        ...
                        <div class="card-title">
                            <h4>Pencils-colors</h4>
                        </div>
                        <div class="card-text">
                            24 Wood Pencils<br>
                            2.05mm, 24 ct from up & up<br>
                            Made of real wood and easy to sharpen<br>
                ...
                <div class="col-lg-3 col-md-12">
                    <div class="card-1">
                        ...
                        <div class="card-text">
                            Ready for use right out of the box<br>
                            Bold colors and presharpened tips<br>
                            <div class="product-content">
                                <div class="price">Rs.250</div>
