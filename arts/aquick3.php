    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Paint Brush Set</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Paint brush set comes with 6 different brushes
                            Monogrammed handles tell you the best use for each brush
                            Synthetic bristles are easy to wash so you can use them over and over again
                            Pair this brush set with any of Hand Made Modern's canvases
                            Start a fun art project today</h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/paintbrush.png">
                        <div class="card-title">
                            <h4>Small Size paint Brush</h4>
                        </div>
                        <div class="card-text">
                            Paint brush set comes with 7 different brushes
                            Monogrammed handles tell you the best use for each brush
                            Synthetic bristles are easy to wash so you can use them over and over again
                            Pair this brush set with any of Hand Made Modern's canvases
                            Start a fun art project today
