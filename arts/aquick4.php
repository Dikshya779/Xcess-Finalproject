                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active"> <img class="d-block w-100"
                                src="../assets/markers paint set.png"
                                alt="">
                        </div>
                        <div class="carousel-item"> <img class="d-block w-100"
                                src="../assets/markerss.webp"
                                alt=" "> </div>
                    </div>
            ...
            <div class="col-lg-6 col-sm-12 information">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        &nbsp; &nbsp;
                        <h5 class="star">5 stars rating</h5>
                    </div>
                    ...
                    <div class="row mt-4 colors">
                        ...
                        <a class="btn btn-primary text-light">
                            blue</a>&nbsp;<a class="btn btn-warning text-light">
                            yellow</a>&nbsp;<a class="btn btn-danger text-light">
                            red</a>&nbsp;<a class="btn btn-dark text-light">
                            black</a>&nbsp;<a class="btn btn-success text-light">
                            green</a>&nbsp;
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>The Hand Made Modern 24ct acrylic paint set is perfect for any artist
                            Mix the paints to create even more color options
                            High-quality acrylic paint (0.04oz) tubes
                            Aluminum tubes with secure caps
                            Start your next art project today</h6>
                    </h5>
