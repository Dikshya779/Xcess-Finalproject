    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="margin-right: 17rem;">Permanent Paint Markers</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
                    ...
                    <div class="row mt-4 colors">
                        ...
                        <a class="btn btn-danger text-light">
                            pink</a>&nbsp;<a class="btn btn-primary text-light">
                            blue</a>&nbsp;<a class="btn btn-dark text-light">
                            black</a>&nbsp;<a class="btn btn-warning text-light">
                            yellow</a>&nbsp;
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>For painting, drawing, coloring and more
                            Conforms to ASTMD -4236
                            Ink may stain certain surfaces
                            Paint markers work great on paper, glass, metal wood and plastic</h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/permanentm.png">
                        <div class="card-title">
                            <h4>Permanent Markers</h4>
                        </div>
                        <div class="card-text">
                            Acrylic paint markers come filled with water-soluble paint
                            Permanent paint markers provide long-lasting color
                            Multicolored paint markers perfect for a variety of craft projects
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="middleFooter">
                        ...
                        <a href="C:\Users\DELL\OneDrive\Desktop\excessProject-master\index1.html">
                            <li>Home</li>
                        </a>
                        <a href="#">
                            <li>Contact Us
