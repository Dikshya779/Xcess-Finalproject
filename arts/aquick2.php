    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="padding-right: 20%;">Handmade Art canvas</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>No matter what inspiration you're following, a set of Hand Made Modern® Canvas Squares make
                            a great starting point for your next craft project. Whether you want to apply paint, paste
                            photos or pin items onto this canvas, the durable surface is just what you're looking for.
                            These canvas frames are made with a sturdy wooden base that's perfect for mounting on walls.
                        </h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/rectart.png">
                        <div class="card-title">
                            <h4>Rect-Art canvas</h4>
                        </div>
                        <div class="card-text">
                            Durable white canvas squares for craft projects
                            Finished masterpieces look great on walls or shelves
                            Canvas base is perfect for a variety of crafts
