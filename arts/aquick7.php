    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="margin-right: 13rem;">Craft Stick</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Includes 75 solid and patterned craft sticks
                            Part of Kid Made Modern Craft Collection
                            Ages 3+
                            Encourages open-ended play</h6>
                    </h5>
                ...
                <div class="col-lg-3 col-sm-12">
                    <div class="card">
                        <img class="card-img-top img-fluid"
                            src="../assets/paintsticks.png">
                        <div class="card-title">
                            <h4>Paint Stick</h4>
                        </div>
                        <div class="card-text">
                            Quick dry paint for mess-free crafting
                            Includes 9 rainbow-hued paint sticks
