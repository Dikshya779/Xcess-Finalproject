    ...
    <div class="container">
        <div class="row">
                ...
                <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active"> <img class="d-block w-100"
                                src="../assets/journalingset.png"
                                alt="">
                        </div>
                        <div class="carousel-item"> <img class="d-block w-100"
                                src="../assets/journalset2.png"
                                alt=" "> </div>
                    </div>
            ...
            <div class="col-lg-6 col-sm-12 information">
                <div class="row">
                    <h1 style="margin-right: 17rem;">DIY Journaling Set</h1>
                    &nbsp; &nbsp;
                    &nbsp; &nbsp;
                </div>
                <div class="col-md-6">
            ...
            <div class="media">
                <div class="media-body">
                    <h5 class="mt-0">Description<br>
                        <h6>Personalize up to 30 pages of your thoughts with journal
                            Includes 30 pages. Colorful chipboard pieces, glitter frames, suede tassel, magnetic
                            bookmarks, printed pages, glue stick, and a gel pen.</h6>
                    </h5>
